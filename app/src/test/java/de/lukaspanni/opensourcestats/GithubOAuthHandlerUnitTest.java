...
public class GithubOAuthHandlerUnitTest {
    ...
    private GithubOAuthHandler getAuthHandlerWithSharedPreferences(String str) {
        return getAuthHandlerWithSharedPreferences(str, null);
    }

    private GithubOAuthHandler getAuthHandlerWithSharedPreferences(String str, SharedPreferences.Editor mockEditor) {
        ...
        return new GithubOAuthHandler(new MockAuthHandlerActivity(sharedPreferences));
    }

    @Test
    public void test_auth_handler_checkAuth_authenticated() {
        //Bad Testability of AuthHandler due to use of SharedPreferences
        GithubOAuthHandler handler = getAuthHandlerWithSharedPreferences(AUTH_STATE_JSON);
    ...
    public void test_auth_handler_checkAuth_not_authenticated() {
        GithubOAuthHandler handler = getAuthHandlerWithSharedPreferences(null);
    ...
    public void test_auth_handler_write_AuthState() {
        ...
        GithubOAuthHandler handler = getAuthHandlerWithSharedPreferences(AUTH_STATE_JSON, mockEditor);
